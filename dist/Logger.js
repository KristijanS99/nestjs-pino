...
let Logger = class Logger {
    ...
    call(level, message, ...optionalParams) {
        var _a, _b;
        (_b = (_a = PinoLogger_1.PinoLogger.getActiveSpan) === null || _a === void 0 ? void 0 : _a.call(PinoLogger_1.PinoLogger)) === null || _b === void 0 ? void 0 : _b.setAttribute(`logger.${level}.${new Date().toISOString()}`, JSON.stringify({ message, ...optionalParams }));
        const objArg = {};
